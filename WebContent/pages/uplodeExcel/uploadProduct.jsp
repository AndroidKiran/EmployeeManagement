			...
			<td>
				<div id="main">
		  			<div id="m2">
		  				<div id="m3">
		  					<div align="center">
		  						<s:form enctype="multipart/form-data" theme="simple" name="impDoc" method="post" action="/ImportProduct.action" >
			<table align="center" id="getAllDetails" name="getAllDetails">
				<tr><td>
					<table align="center" class="tableStyle">
						<tr>
							<td class="tableheader" align="middle" width="728" height="6">Import Excel for Product</td>
						</tr>
						<tr><td>
							<br><br></td></tr>
						<tr>
			...
			<br/><br/>
				...
				<tr><td>
					<table align="center" class="tableStyle" cellspacing="2">
						<tr>
							<td>
								<s:submit name="Submit" value="Upload" id="button" onclick="return validateImportProduct();"  />
							</td>
							<td>&nbsp;&nbsp;&nbsp;</td>
							<td>
