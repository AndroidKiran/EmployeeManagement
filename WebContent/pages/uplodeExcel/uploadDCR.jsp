			...
			<td>
				<div id="main">
		  			<div id="m2">
		  				<div id="m3">
		  					<div align="center">
		  						<s:form enctype="multipart/form-data" theme="simple" name="impChem" method="post" action="/ImportDCR.action" >
			<table align="center" id="getAllDetails" name="getAllDetails">
				<tr><td>
					<table align="center" class="tableStyle">
						<tr>
							<td class="tableheader" align="middle" width="728" height="6">Import Excel for DCR</td>
						</tr>
						<tr>
							<td colspan="4">&nbsp;</td>
						</tr>
					...
					<table align="center"  class="tableStyle">
						<tr>
							...
							<td class="labelcell" width="40%" height="23">
								Select Excel File (.xls) :<font class="ErrorText">*</font>
							</td>
							<td>&nbsp;&nbsp;&nbsp;</td>
							<td>
			...
			<br/><br/>
				<tr><td>
					<table align="center" class="tableStyle" cellspacing="2">
						<tr>
							<td>
								<s:submit name="Submit" value="Upload" id="button" onclick="return validateDCRUpload();"  />
							</td>
							<td>&nbsp;&nbsp;&nbsp;</td>
							<td>
...
<script type="text/javascript">
function validateDCRUpload(){
	
	if(document.getElementById('empId').value==""){
		alert("Please select user whose DCR is to be Uploaded");
		return false;
	}
