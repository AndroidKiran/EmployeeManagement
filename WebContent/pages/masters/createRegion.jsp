    ...
    <head>
        ...
        <script>
			...
			function validation() {
				...
				if(!isNaN(document.getElementById('regionName').value)) {
					alert("Region Name can not be a numeric value.");
					document.getElementById('regionName').value="";
	...
	<table align="center">
		<tr> 
			<td>
				<div id="main">
		  			<div id="m2">
		  				<div id="m3">
		  					<div align="center">
		  						<form name="roleForm" method="post" action="/maa/CreateRegion.action?bool=CREATE" onsubmit="return validation()"><div><input type="hidden" name="org.apache.struts.taglib.html.TOKEN" value="cd26b486fa21a3d69bf8bf3fa6505400"></div>
			<table align="center" id="getAllDetails" name="getAllDetails">
				<table align="center" class="tableStyle">
					<tr>
						<td class="tableheader" align="middle" width="728" height="6">Create Region</td>
					</tr>
					<tr>
						<td colspan="4">&nbsp;</td>
					</tr>
			...
			<table align="center"  class="tableStyle">
				...
				<tr>
					<td  class="labelcell" width="40%" height="23" >Region Name<font class="ErrorText">*</font></td>
					<td  class="labelcell" align="left" width="40%" height="23" >
						<input type="text" name="regionName" value="" id="regionName" class="ControlText">
					</td>
				</tr>
				<tr>
					<td class="labelcell"  width="40%" height="23" >Region Description</td>
					<td class="labelcell"  align="left" width="40%" height="23" >
						<input type="text" name="regionDesc" value="" id="regionDesc" class="ControlText">
					</td>
				</tr>
			</table>
			<br/><br/>
