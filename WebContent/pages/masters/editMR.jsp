			...
			<td>
				<div id="main">
		  			<div id="m2">
		  				<div id="m3">
		  					<div align="center">
		  						<s:form theme="simple" name="updateMrForm" method="post" >
					...
					<table align="center"  class="tableStyle">
						...
						<tr>
							...
							<td  class="labelcell" align="left" width="40%" height="23" >
								<s:textfield name="emp_name" value="%{emp_name}" id="emp_name" class="ControlText"/>
							</td>				
						
							<td class="labelcell"  width="40%" height="23" >Designation</td>
							<td class="labelcell"  align="left" width="40%" height="23" >
								<s:select theme="simple" name="dsg_id" value="%{dsg_id}" id="dsg_id" list="dsgnList" listKey="dsgId" listValue="dsgName" headerKey="" headerValue="--Select--" cssClass="ControlText"/>
							</td>
						...
						<tr>
							...
							<td class="labelcell" valign="bottom" align="left" width="15%" height="20">
								<s:textfield name="dob" value="%{dob}" size="15" onkeyup="DateFormat(this,this.value,event,false,'3')" onblur="validateDateFormat(this);" id="dob" class="ControlText"/>
							...
							<td class="labelcell" valign="bottom" align="left" width="15%" height="20">
								<s:textfield name="doj" value="%{doj}" size="15" onkeyup="DateFormat(this,this.value,event,false,'3')" onblur="validateDateFormat(this);" id="doj" class="ControlText"/>
						...
						<tr>
							...
							<td class="labelcell"  align="left" width="40%" height="23" >
								<s:textfield name="emg_contact_no" value="%{emg_contact_no}" id="emg_contact_no" class="ControlText" onkeyup="validateEmgPhoneNumber();"/>
							</td>
			...
			<br/><br/>
				<tr><td>
					<table align="center" class="tableStyle" cellspacing="2">
						<tr>
							<td>
								<input type="button" value="UPDATE" id="button" name="Submit" onclick="return UpdateMR();"/>
							</td>
							<td>&nbsp;&nbsp;&nbsp;</td>
							<td>
...
function UpdateMR()
{
	bodyonload(); 		//this is used to pre-select territory value
	
	if(validateAgainMR()){	
		//alert("16");
		document.updateMrForm.action='/maa/updateMR';
		document.updateMrForm.submit();
	}
	//else return false;
}
