...
<html>
	...
	<body >
		...
		<s:actionerror />
		<s:fielderror />
		<s:form action="UploadTerritory" method="POST" enctype="multipart/form-data" theme="simple">
			...
			<p>File: <s:file name="upload" label="File" /> <s:submit value="Upload" id="butSubmit"  /><!-- onclick="showLoader()" -->
