...
<html>
	...
	<body >
		...
		<s:actionerror />
		<s:fielderror />
		<s:form action="ExportTerritory" method="POST" enctype="multipart/form-data" theme="simple">
			...
			<p>File: Export <s:submit value="Export" id="exportData"  /><!-- onclick="showLoader()" -->
