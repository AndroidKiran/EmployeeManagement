		...
		<tr> 
			<td>
				<div id="main">
		  			<div id="m2">
		  				<div id="m3">
		  					<div align="center">
		  						<s:form name="searchDoctor" action="/searchChemist" method="post" theme="simple" >
			...
			<table align="center"  class="tableStyle">
				...
				<tr>
					...
					<td  class="labelcell" align="left" width="40%" height="23" >
						<s:textfield name="chemist_name" value="" id="chemist_name" cssClass="ControlText"/>
					</td>	
			...
			<s:if test="%{chemList!=null}">
				...
				<tr>
					...
					<td class="tablesubcaption" valign="bottom" align="left" width="20%" height="20">Chemist Name</td>
				  ...
				  <tr id="reasonrow">
				  	<s:iterator value="chemList" var="cont" status="stat">
					<s:hidden name="chemist_id"/>
				  	<td class="labelcell" valign="bottom" align="left" width="5%" height="20">
		               <s:property value="%{#stat.index + 1}" />
		            </td>
				    <td class="labelcell" valign="bottom" align="left" width="20%" height="20"><s:property value="chemist_name"/></td>
		            	...
		            	<table border="1" width="100%" align="center" class="tableStyle">
		            		<tbody><tr>
		            			...
		            			<!-- Make an action for edit, here it is editMR -->
				             	<td class="labelcell" valign="bottom" align="left" width="20%" height="20"><a href="/maa/editChemist?chemist_id=<s:property value="chemist_id"/>&amp;">Edit</a></td>
				             	<td class="labelcell" valign="bottom" align="left" width="20%" height="20"><a href="/maa/editChemist?chemist_id=<s:property value="chemist_id"/>&amp;"><img src="/maa/images/page_edit.png" alt="Edit Data"  border="0" width="16" height="16"></a></td>
		             		</tr>
		             		<tr>
		             			<td class="labelcell" valign="bottom" align="left" width="20%" height="20"><a href="/maa/viewChemist?chemist_id=<s:property value="chemist_id"/>&amp;">View</a></td>
				             	<td class="labelcell" valign="bottom" align="left" width="20%" height="20"><a href="/maa/viewChemist?chemist_id=<s:property value="chemist_id"/>&amp;"><img src="/maa/images/page_view.png" alt="View Data"  border="0" width="16" height="16"></a></td>
