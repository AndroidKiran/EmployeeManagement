			...
			<td>
				<div id="main">
		  			<div id="m2">
		  				<div id="m3">
		  					<div align="center">
		  						<s:form theme="simple" name="holidayFormSearch" method="post" action="/CreateHoliday.action" enctype="multipart/form-data" onsubmit=" return validateHoliday();">
				...
				<table align="center" class="tableStyle" width="100%">
					<tr align="center">
						<td align="center" valign="bottom" height="20">
							<input type="button" value="Back" style="font-size:12px" onclick=" return goBackToCreateHoliday();">
						</td>
					</tr>
					<tr>
...
<script type="text/javascript">
	function goBackToCreateHoliday()
	{
		document.holidayFormSearch.action='/maa/populateRegion';
		document.holidayFormSearch.submit();
	}
