...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="load(),onloadctrmap(lat,lng),loadStates();" onunload="GUnload();" onresize="resizeMapDiv()">
	 -->
	<body onload="loadImage();MM_preloadImages()" class="yui-skin-sam" bgcolor="#D4EAF5">
				...
				<tr>
					<td>
						...
						<div class="navibarportal">																		
							<div>
								<div style="margin-top:2px;width:400px;position:absolute;"><span class="fonthome"  onclick="showMainMenu()" style="margin-left:5px;display:none;cursor:pointer" id="homebtn">Home &nbsp;&nbsp;<img  src="<%=request.getContextPath()%>/images/dline.gif" style="cursor:default;"/>&nbsp;&nbsp;</span><span class="fonthome" style=";display: inline;"><font style="font-weight:lighter">&nbsp;Welcome</font>&nbsp; <s:property value="#session.UserName"/></span></div>				
								...
								<tr>
									<td  id="sidebar" width="265px" bgcolor="#93C8E9" valign="top" height="480px">
										<div  class="rightpersonalboxplain">
											...
											<div id="accordion5" class="accordiondiv">
												<dl class="accordion" id="slider5">
													...
													<span id="selfservicespan">
																...
																<a id='ss#829'  name='fave' class="buttonforaccord lineheight"  href='javascript:void(0);' onclick= "PopupCenter('/maa/populateRole.action','portalApp829', 850,600)">Create User</a><!-- pages/userManagement/createUser.jsp -->
																<br/>      		
												         		
																<a id='ss#834'  name='fave' class="buttonforaccord lineheight"  href='javascript:void(0);' onclick= "PopupCenter('/maa/pages/transactions/upload.jsp','portalApp834', 850,600)">Upload Territory</a>
																<br/> 
																
																<a id='ss#838'  name='fave' class="buttonforaccord lineheight"  href='javascript:void(0);' onclick= "PopupCenter('/maa/popUserForDcrImport.action','portalApp838', 850,600)">Upload DCR</a>
																<br/> 
																     		
																<a id='ss#827'  name='fave' class="buttonforaccord lineheight"  href='javascript:void(0);' onclick= "PopupCenter('/maa/pages/transactions/upload.jsp','portalApp827', 850,600)">Export Territory</a>
																<br/>      		
												         		
																<a id='ss#830'  name='fave' class="buttonforaccord lineheight"  href='javascript:void(0);' onclick= "PopupCenter('/maa/test.action','portalApp830', 850,600)">test for tp</a>
																<br/>      		
																...
																<a id='ss#834'  name='fave' class="buttonforaccord lineheight"  href='javascript:void(0);' onclick= "PopupCenter('/maa/popUserForSearchTPForAdmin.action','portalApp834', 850,600)">Search Tour Plan User-Wise</a>
																<br/>   
																   		
																<a id='ss#835'  name='fave' class="buttonforaccord lineheight"  href='javascript:void(0);' onclick= "PopupCenter('/maa/popUserForSearchDCRForAdmin.action','portalApp835', 850,600)">Search DCR User-Wise</a>
																<br/>      
																		
																<a id='ss#835'  name='fave' class="buttonforaccord lineheight"  href='javascript:void(0);' onclick= "PopupCenter('/maa/findRegion.action','portalApp835', 850,600)">Create Holiday</a>
																<br/>      		
											...
											<br/>
											<div id="accordion6" class="accordiondiv">
												<dl class="accordion" id="slider6">
													<dt style= "background-color:#416a9c;font-size:14px;font-family: Arial;font-weight: bold;color: #CCC;" ><img src="<%=request.getContextPath()%>/images/adminPanel.jpeg" style="margin-right:6px" height="16" width="16"/>Administration</dt>
													<dd id="administration">	
													<span id="selfservicespan">
														
																<a id='ss#845'  name='fave' class="buttonforaccord lineheight"  href='javascript:void(0);' onclick= "PopupCenter('/maa/populateRole.action','portalApp845', 850,600)">Create User</a><!-- pages/userManagement/createUser.jsp -->
																<br/>   
																
																<a id='ss#846'  name='fave' class="buttonforaccord lineheight"  href='javascript:void(0);' onclick= "PopupCenter('/maa/pages/userManagement/searchUser.jsp','portalApp846', 850,600)">Search User</a>   		
																<br/>      		
												         		
																<a id='ss#847'  name='fave' class="buttonforaccord lineheight"  href='javascript:void(0);' onclick= "PopupCenter('/maa/pages/masters/createRole.jsp','portalApp847', 850,600)">Create Role</a>
																<br/>      		
												         		
											<!-- 					<a id='ss#848'  name='fave' class="buttonforaccord lineheight"  href='javascript:void(0);' onclick= "PopupCenter('/egi/index.jsp','portalApp848', 850,600)">Masters</a>
																<br/>      
																		
																<a id='ss#849'  name='fave' class="buttonforaccord lineheight"  href='javascript:void(0);' onclick= "PopupCenter('/maa/DocList.action','portalApp849', 850,600)">Tour Planning</a>
																<br/>  
												 -->						
																<a id='ss#850'  name='fave' class="buttonforaccord lineheight"  href='javascript:void(0);' onclick= "PopupCenter('/maa/pages/masters/createRegion.jsp','portalApp850', 850,600)">Create Region</a>
																<br/>   
																   		
																<a id='ss#851'  name='fave' class="buttonforaccord lineheight"  href='javascript:void(0);' onclick= "PopupCenter('/maa/populateRegion.action','portalApp851', 850,600)">Create Holiday</a>
																<br/>      		
...
<!-- 																						
											...
											<br />		
 -->																				
											<div id="accordion8" class="accordiondiv">
												<dl class="accordion" id="slider8">
												
													<dt style= "background-color:#416a9c;font-size:14px;font-family: Arial;font-weight: bold;color: #CCC;" ><img src="<%=request.getContextPath()%>/images/mr.jpeg" style="margin-right:6px" height="16" width="16"/>Masters</dt>
													<dd id="masters">	
														<span id="selfservicespan">
																		
																<a id='ss#853'  name='fave' class="buttonforaccord lineheight"  href='javascript:void(0);' onclick= "PopupCenter('/maa/invokeTerritoryListForMR.action','portalApp853', 850,600)">New MR Details</a>
																<br/>  
																 		
																<a id='ss#854'  name='fave' class="buttonforaccord lineheight"  href='javascript:void(0);' onclick= "PopupCenter('/maa/invokeListForDoctor.action','portalApp854', 850,600)">New Doctor</a>
																<br/>  
																 		
																<a id='ss#855'  name='fave' class="buttonforaccord lineheight"  href='javascript:void(0);' onclick= "PopupCenter('/maa/invokeTerritoryListForChemist','portalApp855', 850,600)">New Chemist</a>
																<br/>   
																		
																<a id='ss#856'  name='fave' class="buttonforaccord lineheight"  href='javascript:void(0);' onclick= "PopupCenter('/maa/pages/masters/addTerritory.jsp','portalApp856', 850,600)">Create Territory</a>
																<br/>   
																		
																<a id='ss#857'  name='fave' class="buttonforaccord lineheight"  href='javascript:void(0);' onclick= "PopupCenter('/maa/invokeListForProduct.action','portalApp857', 850,600)">Add New Product Details</a>
																<br/>   
																		
																<a id='ss#858'  name='fave' class="buttonforaccord lineheight"  href='javascript:void(0);' onclick= "PopupCenter('/maa/pages/masters/addCategory.jsp','portalApp858', 850,600)">Create New Category</a>
																<br/>   
																		
																<a id='ss#859'  name='fave' class="buttonforaccord lineheight"  href='javascript:void(0);' onclick= "PopupCenter('/maa/pages/masters/addReference.jsp','portalApp859', 850,600)">Create Reference Type</a>
																<br/>   
																		
																<a id='ss#860'  name='fave' class="buttonforaccord lineheight"  href='javascript:void(0);' onclick= "PopupCenter('/maa/pages/masters/searchMR.jsp','portalApp860', 850,600)">Search MR</a>
																<br/>   		
											...
											<br />											
											<div id="accordion9" class="accordiondiv">
												<dl class="accordion" id="slider9">
												
													<dt style= "background-color:#416a9c;font-size:14px;font-family: Arial;font-weight: bold;color: #CCC;" ><img src="<%=request.getContextPath()%>/images/mr.jpeg" style="margin-right:6px" height="16" width="16"/>Transactions</dt>
													<dd id="transactions">	
													<span id="selfservicespan">
																...
																<a id='ss#861'  name='fave' class="buttonforaccord lineheight"  href='javascript:void(0);' onclick= "PopupCenter('/maa/territoryListForDoc','portalApp861', 850,600)">Search Doctor</a>
																<br/>   	
																	
																<a id='ss#862'  name='fave' class="buttonforaccord lineheight"  href='javascript:void(0);' onclick= "PopupCenter('/maa/pages/transactions/searchProduct.jsp','portalApp862', 850,600)">Search Product</a>
																<br/>   		
																
																<a id='ss#863'  name='fave' class="buttonforaccord lineheight"  href='javascript:void(0);' onclick= "PopupCenter('/maa/territoryListForChem','portalApp863', 850,600)">Search Chemist</a>
																<br/>  
																
																<a id='ss#864'  name='fave' class="buttonforaccord lineheight"  href='javascript:void(0);' onclick= "PopupCenter('/maa/popUserForSearchTPForAdmin.action','portalApp864', 850,600)">Search Tour Plan User-Wise</a>
																<br/>   
																   		
																<a id='ss#865'  name='fave' class="buttonforaccord lineheight"  href='javascript:void(0);' onclick= "PopupCenter('/maa/popUserForSearchDCRForAdmin.action','portalApp865', 850,600)">Search DCR User-Wise</a>
																<br/>  
																  		
																<a id='ss#866'  name='fave' class="buttonforaccord lineheight"  href='javascript:void(0);' onclick= "PopupCenter('/maa/popUserForDcrImport.action','portalApp866', 850,600)">Upload DCR User-Wise</a>
																<br/>  
