											...
											<div id="accordion5" class="accordiondiv">
												<dl class="accordion" id="slider5">
													...
													<span id="selfservicespan">
																...
																<a id='ss#834'  name='fave' class="buttonforaccord lineheight"  href='javascript:void(0);' onclick= "PopupCenter('/maa/pages/userManagement/createRole.jsp','portalApp834', 850,600)">Create Role</a>
																<br/>      		
												         		
																<a id='ss#830'  name='fave' class="buttonforaccord lineheight"  href='javascript:void(0);' onclick= "PopupCenter('/egi/index.jsp','portalApp830', 850,600)">Masters</a>
																<br/>      		
											...
											<div id="accordion6" class="accordiondiv">
												<dl class="accordion" id="slider6">
													...
													<span id="selfservicespan">
																...
																<a id='ss#849'  name='fave' class="buttonforaccord lineheight"  href='javascript:void(0);' onclick= "PopupCenter('/maa/pages/medicalRepresentative/tourPlanning.jsp','portalApp849', 850,600)">Tour Planning</a>
																<br/>  
											...
											<div id="accordion7" class="accordiondiv">
												<dl class="accordion" id="slider7">
													...
													<span id="selfservicespan">
																...
																<a id='ss#848'  name='fave' class="buttonforaccord lineheight"  href='javascript:void(0);' onclick= "PopupCenter('/maa/pages/medicalRepresentative/tourPlanning.jsp','portalApp848', 850,600)">Tour Planning</a>
																<br/>      		
